...
include 'https://markallencoaching.com/oneall/social-login/_include/init.php';
...
//Make Request
if ($oneall_curly->get (https . "https://markallencoaching.com/oneall/users/" . $user_token . ".json"))
{
