...
require 'https://markallencoaching.com/oneall/social-login/_include/init.php';
	...
	<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en-EN">
		<head>
			...
			<script type="text/javascript">
				...
				var oajsf = oajsp + '://<?php echo markallencoaching; ?>.api.oneall.com/socialize/library.js?library=3';
